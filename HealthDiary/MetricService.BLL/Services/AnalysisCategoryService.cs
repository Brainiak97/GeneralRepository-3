...
namespace MetricService.BLL.Services
{
    public class AnalysisCategoryService(IAnalysisCategoryRepository repository, IValidator<AnalysisCategory> validator, ClaimsPrincipal authorizationService) : IAnalysisCategoryService
    {
        ...
        {
            var analysisCategoryFind = await _repository.GetByIdAsync(analysisCategoryUpdateDTO.Id) ??
            ...
            analysisCategoryFind = analysisCategoryUpdateDTO.ToAnalysisCategory();
        ...
        {
            var фnalysisCategoryFind = await _repository.GetByIdAsync(analysisCategoryId) ??
