...
namespace MetricService.BLL.Services
{
    public class AnalysisTypeService(IAnalysisTypeRepository repository, IValidator<AnalysisType> validator, ClaimsPrincipal authorizationService) : IAnalysisTypeService
    {
        ...
        {
            var analysisTypeFind = await _repository.GetByIdAsync(analysisTypeUpdateDTO.Id) ??
            ...
            analysisTypeFind = analysisTypeUpdateDTO.ToAnalysisType();
        ...
        {
            var analysisTypeFind = await _repository.GetByIdAsync(analysisTypeId) ??
